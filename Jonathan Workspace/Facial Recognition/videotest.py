# r"PresentPerfect\Jonathan Workspace\Facial Recognition\runs\train\affectnet_yolov11\weights\best.pt"
# webcam_detect_headcrop_mediapipe.py
import cv2
...
# ------------------------------------------------------------------
# 1.  Initialise YOLO & MediaPipe Face‑Detection
# ------------------------------------------------------------------
model = YOLO(
    r"PresentPerfect\Jonathan Workspace\Facial Recognition\runs\train\affectnet_yolov11\weights\best.pt"
)
...
HEAD_PAD_TOP    = 0.55   # extra space above the face  (hair / forehead)
HEAD_PAD_SIDE   = 0.35   # left + right expansion      (ears / turned head)
HEAD_PAD_BOTTOM = 0.25   # extra below the chin / neck
